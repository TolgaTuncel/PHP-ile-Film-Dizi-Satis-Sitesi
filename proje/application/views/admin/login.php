...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="card">
            ...
            <?php }   ?>
                <form action="<?=base_url()?>admin/login/giris_yap"  id="sign_in" method="POST">
                    <div class="msg">Admin Panel Giriş Sayfası</div>
                    ...
                    <div class="row">
                        <div class="col-xs-8 p-t-5">
                            ...
                            <label for="rememberme">BENI HATIRLA</label>
                        </div>
                        <div class="col-xs-4">

                            <button class="btn btn-block bg-pink waves-effect" value="Giris Yap" type="submit">GIRIS YAP</button>
                        </div>
                    </div>
